...
! function(a) {
    ...
    var b = a.GreenSockGlobals || a,
        ...
        v = d.SplitText = b.SplitText = function(b, c) {
            ...
            return u ? (this.elements = j(b) ? k(b) : [b], this.chars = [], this.words = [], this.lines = [], this._originals = [], this.vars = c || {}, this.split(c), void 0) : (this.elements = j(b) ? k(b) : [b], this.chars = [], this.words = [], this.lines = [], this._originals = [], this.vars = c || {}, this.split(c), void 0)
        },
        w = function(a, b, c) {
            var d = a.nodeType;
            if (1 === d || 9 === d || 11 === d)
